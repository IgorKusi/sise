...
ax[2, 0].legend(['BFS', 'DFS', 'A*'], loc="upper left")
ax[2, 0].set_yticks([1, 10, 100, 1000, 10000, 100000, 1000000])

ax[2, 1].bar(names_axis - 0.5 * width, stats('astr', 'hamm')[1], width, color='lightblue', edgecolor='black')
ax[2, 1].bar(names_axis + 0.5 * width, stats('astr', 'manh')[1], width, color='darkgreen', edgecolor='black')
ax[2, 1].set_title("A*")
...
width = 0.1
ax[3, 0].bar(names_axis - 3.5 * width, stats('bfs', 'rdul')[1], 0.1, color='lightblue', log=True, edgecolor='black')
ax[3, 0].bar(names_axis - 2.5 * width, stats('bfs', 'rdlu')[1], 0.1, color='orange', log=True, edgecolor='black')
ax[3, 0].bar(names_axis - 1.5 * width, stats('bfs', 'drul')[1], 0.1, color='darkgreen', log=True, edgecolor='black')
ax[3, 0].bar(names_axis - 0.5 * width, stats('bfs', 'drlu')[1], 0.1, color='pink', log=True, edgecolor='black')
ax[3, 0].bar(names_axis + 0.5 * width, stats('bfs', 'ludr')[1], 0.1, color='red', log=True, edgecolor='black')
ax[3, 0].bar(names_axis + 1.5 * width, stats('bfs', 'lurd')[1], 0.1, color='magenta', log=True, edgecolor='black')
ax[3, 0].bar(names_axis + 2.5 * width, stats('bfs', 'uldr')[1], 0.1, color='darkblue', log=True, edgecolor='black')
ax[3, 0].bar(names_axis + 3.5 * width, stats('bfs', 'ulrd')[1], 0.1, color='lightgreen', log=True, edgecolor='black')
...
ax[3, 1].bar(names_axis - 3.5 * width, stats('dfs', 'rdul')[1], 0.1, color='lightblue', log=True, edgecolor='black')
ax[3, 1].bar(names_axis - 2.5 * width, stats('dfs', 'rdlu')[1], 0.1, color='orange', log=True, edgecolor='black')
ax[3, 1].bar(names_axis - 1.5 * width, stats('dfs', 'drul')[1], 0.1, color='darkgreen', log=True, edgecolor='black')
ax[3, 1].bar(names_axis - 0.5 * width, stats('dfs', 'drlu')[1], 0.1, color='pink', log=True, edgecolor='black')
ax[3, 1].bar(names_axis + 0.5 * width, stats('dfs', 'ludr')[1], 0.12, color='red', log=True, edgecolor='black')
ax[3, 1].bar(names_axis + 1.5 * width, stats('dfs', 'lurd')[1], 0.1, color='magenta', log=True, edgecolor='black')
ax[3, 1].bar(names_axis + 2.5 * width, stats('dfs', 'uldr')[1], 0.1, color='darkblue', log=True, edgecolor='black')
ax[3, 1].bar(names_axis + 3.5 * width, stats('dfs', 'ulrd')[1], 0.1, color='lightgreen', log=True, edgecolor='black')
...
ax1[0, 0].legend(['BFS', 'DFS', 'A*'], loc="upper left")
# ax1[0, 0].set_yticks([1, 10, 100, 1000, 10000, 100000, 1000000])
width = 0.3
ax1[0, 1].bar(names_axis - 0.5*width, stats('astr', 'hamm')[2], width, color='lightblue', edgecolor='black')
ax1[0, 1].bar(names_axis+ 0.5*width, stats('astr', 'manh')[0], width, color='darkgreen', edgecolor='black')
ax1[0, 1].set_title("A*")
...
width = 0.1
ax1[1, 0].bar(names_axis - 3.5 * width, stats('bfs', 'rdul')[2], width, color='lightblue', log=True, edgecolor='black')
ax1[1, 0].bar(names_axis - 2.5 * width, stats('bfs', 'rdlu')[2], width, color='orange', log=True, edgecolor='black')
ax1[1, 0].bar(names_axis - 1.5 * width, stats('bfs', 'drul')[2], width, color='darkgreen', log=True, edgecolor='black')
ax1[1, 0].bar(names_axis - 0.5 * width, stats('bfs', 'drlu')[2], width, color='pink', log=True, edgecolor='black')
ax1[1, 0].bar(names_axis + 0.5 * width, stats('bfs', 'ludr')[2], width,      color='red', log=True, edgecolor='black')
ax1[1, 0].bar(names_axis + 1.5 * width, stats('bfs', 'lurd')[2], width, color='magenta', log=True, edgecolor='black')
ax1[1, 0].bar(names_axis + 2.5 * width, stats('bfs', 'uldr')[2], width, color='darkblue', log=True, edgecolor='black')
ax1[1, 0].bar(names_axis + 3.5 * width, stats('bfs', 'ulrd')[2], width, color='lightgreen', log=True, edgecolor='black')
...
ax1[1, 1].bar(names_axis - 3.5 * width, stats('dfs', 'rdul')[2], width, color='lightblue', log=True, edgecolor='black')
ax1[1, 1].bar(names_axis - 2.5 * width, stats('dfs', 'rdlu')[2], width, color='orange',  log=True, edgecolor='black')
ax1[1, 1].bar(names_axis - 1.5 * width, stats('dfs', 'drul')[2], width, color='darkgreen', log=True, edgecolor='black')
ax1[1, 1].bar(names_axis - 0.5 * width, stats('dfs', 'drlu')[2], width, color='pink', log=True, edgecolor='black')
ax1[1, 1].bar(names_axis + 0.5 * width, stats('dfs', 'ludr')[2], width,       color='red', log=True, edgecolor='black')
ax1[1, 1].bar(names_axis + 1.5 * width, stats('dfs', 'lurd')[2], width, color='magenta',  log=True, edgecolor='black')
ax1[1, 1].bar(names_axis + 2.5 * width, stats('dfs', 'uldr')[2], width, color='darkblue',  log=True, edgecolor='black')
ax1[1, 1].bar(names_axis + 3.5 * width, stats('dfs', 'ulrd')[2], width, color='lightgreen' ,log=True, edgecolor='black')
...
ax1[2, 0].set_ylabel("Max recursion depth")
...
width = 0.25
ax1[2, 1].bar(names_axis - 0.5*width, stats('astr', 'hamm')[3], width, color='lightblue', edgecolor='black')
ax1[2, 1].bar(names_axis + 0.5*width, stats('astr', 'manh')[3], width, color='darkgreen', edgecolor='black')
ax1[2, 1].set_title("A*")
ax1[2, 1].set_xticks(names_axis, names)
ax1[2, 1].legend(['Hamming', 'Manhattan'])

width = 0.1
ax1[3, 0].bar(names_axis - 3.5 * width, stats('bfs', 'rdul')[3], width, color='lightblue',  edgecolor='black')
ax1[3, 0].bar(names_axis - 2.5 * width, stats('bfs', 'rdlu')[3], width, color='orange', edgecolor='black')
ax1[3, 0].bar(names_axis - 1.5 * width, stats('bfs', 'drul')[3], width, color='darkgreen', edgecolor='black')
ax1[3, 0].bar(names_axis - 0.5 * width, stats('bfs', 'drlu')[3], width, color='pink', edgecolor='black')
ax1[3, 0].bar(names_axis + 0.5 * width, stats('bfs', 'ludr')[3], width,      color='red',  edgecolor='black')
ax1[3, 0].bar(names_axis + 1.5 * width, stats('bfs', 'lurd')[3], width, color='magenta' , edgecolor='black')
ax1[3, 0].bar(names_axis + 2.5 * width, stats('bfs', 'uldr')[3], width, color='darkblue',  edgecolor='black')
ax1[3, 0].bar(names_axis + 3.5 * width, stats('bfs', 'ulrd')[3], width, color='lightgreen', edgecolor='black')
ax1[3, 0].set_ylabel("Max recursion depth")
...
ax1[3, 1].bar(names_axis - 3.5 * width, stats('dfs', 'rdul')[3], width, color='lightblue', edgecolor='black')
ax1[3, 1].bar(names_axis - 2.5 * width, stats('dfs', 'rdlu')[3], width, color='orange',  edgecolor='black')
ax1[3, 1].bar(names_axis - 1.5 * width, stats('dfs', 'drul')[3], width, color='darkgreen',  edgecolor='black')
ax1[3, 1].bar(names_axis - 0.5 * width, stats('dfs', 'drlu')[3], width, color='pink', edgecolor='black')
ax1[3, 1].bar(names_axis + 0.5 * width, stats('dfs', 'ludr')[3], width,       color='red', edgecolor='black')
ax1[3, 1].bar(names_axis + 1.5 * width, stats('dfs', 'lurd')[3], width, color='magenta' ,  edgecolor='black')
ax1[3, 1].bar(names_axis + 2.5 * width, stats('dfs', 'uldr')[3], width, color='darkblue',  edgecolor='black')
ax1[3, 1].bar(names_axis + 3.5 * width, stats('dfs', 'ulrd')[3], width, color='lightgreen',edgecolor='black')
...
ax2[0, 0].legend(['BFS', 'DFS', 'A*'], loc="upper right")
